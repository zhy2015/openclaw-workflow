...
def test_composer_concat_scenes_mixed_transition_types_fallback_to_hard_cut(tmp_path):
    ...
    edit_plan = {
        "transitions": [
            {"type": "hard_cut", "from_scene": 0, "to_scene": 1},
            {"type": "crossfade", "from_scene": 1, "to_scene": 2, "duration_ms": 250},
        ],
    ...
    assert "mixed_types:" in edit_plan["execution"]["transition_warning"]
